...
def build_command(
    ...
    platform: str = typer.Option(None, "--platform", help="Target platform for Docker build (e.g., linux/amd64, linux/arm64)"),
    ...
    if result.success:
        ...
        image_name = getattr(result, 'image_name', None) or getattr(result, 'image_url', None)
        if image_name:
